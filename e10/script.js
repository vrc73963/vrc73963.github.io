// API Key for OpenWeatherMap (you'll need to get your own free API key)
const apiKey = '9c019516425808b7d42b532278701d28'; // Replace with your actual API key
...
function fetchWeatherData() {
    ...
    // API URL
    const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${9c019516425808b7d42b532278701d28}`;
